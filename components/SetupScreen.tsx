                            ...
                            <div className="flex space-x-2 md:space-x-0 md:flex-col md:space-y-2">
                                {Object.values(AIRLINE_CONCEPTS).map((c) => (
                                    <button
                                        ...
                                        className={`flex-1 py-2 px-3 rounded-lg border-2 transition-all text-left group flex items-center justify-between ${concept === c.id
                                ...
                                {Object.values(STARTING_CAPITAL_LEVELS).map((level) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex-1 md:flex-none py-2 px-3 rounded-lg border-2 transition-all flex items-center justify-between ${capital === level.id
