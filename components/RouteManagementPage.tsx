    ...
    for (const stats of dailyStats.values()) {
        ...
        if (airlineProfile) {
            ...
            if (originAirport && destAirport) {
                const isOriginForeignOffice = originCode && originAirport.country !== airlineProfile.country && airlineProfile.hubs.includes(originCode);
                const isDestForeignOffice = destCode && destAirport.country !== airlineProfile.country && airlineProfile.hubs.includes(destCode);
      ...
      if (stats.route.priceStrategy) {
        ...
        stats.demand.first = stats.route.demandClasses.first * competitionMod * brandDemandModifier.first * priceStrategy.demandModifier.first * otpDemandModifier * satisfactionDemandModifier.first;
        stats.demand.business = stats.route.demandClasses.business * competitionMod * brandDemandModifier.business * priceStrategy.demandModifier.business * otpDemandModifier * satisfactionDemandModifier.business;
        stats.demand.economy = stats.route.demandClasses.economy * competitionMod * brandDemandModifier.economy * priceStrategy.demandModifier.economy * otpDemandModifier * satisfactionDemandModifier.economy;
